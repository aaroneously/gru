...
giving a more powerful interface to
...
func main() {
	...
	/*
	   ...
	   the elements they contain (not the number
	   of elements). To create an empty slice
	   with non-zero length, use the builtin
	   make. Here we make a slice of strings
