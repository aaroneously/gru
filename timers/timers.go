...
tasks easy. We’ll look first at timers and then at
tickers.
*/
func main() {
	...
	*/
	...
	/*
		Give the timer2 enough time to fire, if
		it ever was going to, to show it is in
		fact stopped.
	*/
...
*/
/*
➜  gru git:(main) ✗ go run timers/timers.go
Timer 1 fired
Timer 2 stopped
*/
