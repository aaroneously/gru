...
/*
A goroutine is a lightweight thread of
execution.
*/
...
func main() {
	...
	/*
		...
		Here’s how we’d call that in the usual
	...
	*/
	...
	/*
		...
		execute concurrently with the calling
		one.
	*/
	go f("goroutine")
	...
	*/
	...
	/*
		...
		Wait for them to finish (for a more robust
...
because goroutines are being run concurrently by the Go
runtime.
*/
/*
➜  gru git:(main) ✗ go run goroutines/goroutines.go
direct : 0
direct : 1
direct : 2
going
