...
func main() {
	...
	/*
		...
		<-messages case with that value. If not it will
	...
	*/
	...
	/*
		...
		has no buffer and there is no receiver. Therefore
...
/*
➜  gru git:(main) go run non-blocking-channel-ops/non-blocking-channel-ops.go
no message received
no message sent
no activity
