...
In the mutexes example we used explicit locking with mutexes to
...
receive corresponding replies. These readOp and writeOp structs
...
func main() {
	...
	*/
	...
	/*
		...
		in the previous example but now private to the stateful goroutine.
	...
	*/
	...
	/*
		...
		sending it over the reads channel, and then receiving the result over
...
➜  gru git:(main) ✗ go run stateful-goroutines/stateful-goroutines.go
readOps: 87500
writeOps: 8750
